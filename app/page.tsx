...
export default function PortfolioOS() {
  ...
  useEffect(() => {
    fetchProjects(); // Fetch immediately on load

    // Set up a timer to fetch again every 5 seconds
    const interval = setInterval(() => {
      fetchProjects(true); // 'true' means silent refresh (don't show loading spinner)
    }, 5000);
